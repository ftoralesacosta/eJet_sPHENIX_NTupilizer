...
shifter --image=docker:ddixit/fun4all:eicresearch /project/projectdirs/alice/ftorales/new_Singularity/Singularity/e_Jet_sPHENIX/cori_batch/gnu_parallel/gnu_parallel_EIC_shifter.sh $1 $2 $rando
