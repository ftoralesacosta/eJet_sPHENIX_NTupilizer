...
parser.add_argument('-d', '--dir',type=str,
                    default='/p/lustre2/ftorales/', #Change for each user
                    help='top level scratch directory')
parser.add_argument('-j', '--jobset',type=str,default='eP_MC',
                    help='jobset name for this jobset [eP_MC]')
...
# write job script
    ...
    f.write('srun -n 1 /p/lustre2/ftorales/Singularity/e_Jet_sPHENIX/slurm_batch/jet_batch.sh /hip_sphenix/eP_MC/'+jobname+'.Root\n')
    f.write('date\n')
    f.close()
